...
namespace my
{
	...
	void MyFmod::Initialize()
	{
		...
		mSystem->initialize(1024, FMOD_STUDIO_INIT_NORMAL, FMOD_INIT_NORMAL, extraDriverDate);
		...
		//const float DISTANCEFATOR = 1.0f;
		//result = sound1->set3DMinMaxDistance(0.5f * DISTANCEFATOR, 5000.0f * DISTANCEFATOR);
		//result = sound1->setMode(FMOD_LOOP_OFF);

		//FMOD_VECTOR pos = { 0.0f * DISTANCEFATOR, 0.0f, 10.0f };
	...
	void MyFmod::Set3DListenerAttributes(const Vector2* pos)
	{
		// -1 ~ 1
